...
const appId = channel === "prod" ? "ai.koala.desktop" : `ai.koala.desktop.${channel}`
const productName = channel === "prod" ? "Koala" : `Koala ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Koala is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
