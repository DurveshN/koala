export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Koala-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Koala-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
