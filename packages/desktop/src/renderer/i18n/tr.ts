export const dict = {
  ...
  "desktop.updater.none.message": "Koala'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Koala'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
