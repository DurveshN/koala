export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Koala. Chcete ji nainstalovat a aplikaci znovu spustit?",
