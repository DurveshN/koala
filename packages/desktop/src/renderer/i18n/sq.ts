export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Koala është shkarkuar, dëshironi ta instaloni dhe rinisni?",
