export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Koala-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Koala-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
