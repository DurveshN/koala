export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Koala wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
