export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Koala is gedownload. Wil je deze installeren en Koala opnieuw starten?",
