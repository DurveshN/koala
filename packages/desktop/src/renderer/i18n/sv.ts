export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Koala har laddats ned. Vill du installera den och starta om programmet?",
