export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av Koala.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av Koala er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
