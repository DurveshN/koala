export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Koala. ¿Quieres instalarla y reiniciar?",
