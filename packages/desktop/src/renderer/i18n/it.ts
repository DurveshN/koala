export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Koala è stata scaricata. Vuoi installarla e riavviare l'app?",
