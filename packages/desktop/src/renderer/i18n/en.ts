export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Koala has been downloaded, would you like to install it and relaunch?",
