export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Koala versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Koala versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
