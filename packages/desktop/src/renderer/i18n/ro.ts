export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Koala a fost descărcată. Vrei să o instalezi și să repornești?",
