export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Koala versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
