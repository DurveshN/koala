export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Koala er blevet downloadet. Vil du installere den og genstarte?",
