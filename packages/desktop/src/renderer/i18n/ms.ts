export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Koala telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
