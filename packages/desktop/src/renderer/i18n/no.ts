export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Koala er lastet ned. Vil du installere den og starte på nytt?",
