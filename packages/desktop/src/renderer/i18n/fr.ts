export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Koala a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
