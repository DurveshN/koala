export const dict = {
  ...
  "desktop.updater.none.message": "Már az Koala legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Koala {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
