export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Koala uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Koala'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
