export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Koala",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Koala. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
