...
- `koala.settings.dat` (URL del servidor predeterminado de escritorio)
- `koala.global.dat` y `opencode.workspace.*.dat` (estado de la interfaz de usuario como servidores/proyectos recientes)
