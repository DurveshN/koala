...
- `koala.settings.dat` (domyślny adres URL serwera na komputerze stacjonarnym)
- `koala.global.dat` i `opencode.workspace.*.dat` (stan interfejsu użytkownika, taki jak najnowsze serwery/projekty)
