export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Koala",
  "desktop.recovery.terminated": "توقفت نافذة Koala بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Koala لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Koala",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "Koala غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "Koala مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "Koala غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Koala، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Koala",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Koala Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Koala.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في Koala.json",
  ...
  "dialog.server.description": "تبديل خادم Koala الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Koala...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Koala في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Koala...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Koala في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Koala في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Koala في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Koala من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Koala التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Koala.",
  ...
  "help.tabs.introduction": "أصبح Koala Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Koala ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Koala",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (Koala.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Koala لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Koala نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Koala داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Koala",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Koala على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Koala يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Koala.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Koala",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Koala.",
