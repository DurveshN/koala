export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Koala",
  ...
  "desktop.menu.ariaLabel": "Menu do Koala",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Koala",
  "desktop.recovery.terminated": "A janela do Koala foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Koala não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Koala",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O Koala não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O Koala está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O Koala não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Koala foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Koala",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Koala.",
  ...
  "dialog.plugins.empty": "Plugins configurados em Koala.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Koala este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Koala em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Koala em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Koala em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Koala",
  "wsl.onboarding.opencodeReadyIn": "O Koala está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Koala está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Koala em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Koala possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Koala não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Koala novamente.",
  ...
  "help.tabs.introduction": "Agora, o Koala Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Koala ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Koala",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (Koala.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Koala ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Koala dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Koala",
  ...
  "settings.general.row.appearance.description": "Personalize como o Koala aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Koala segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Koala é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Koala iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Koala.",
