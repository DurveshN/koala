export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Koala",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Koala",
  "desktop.recovery.terminated": "La fenêtre Koala s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Koala ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Koala",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "Koala n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "Koala est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "Koala n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Koala est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Koala",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Koala.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans Koala.json",
  ...
  "dialog.server.description": "Changez le serveur Koala auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Koala dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Koala dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Koala dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Koala dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Koala puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Koala n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Koala ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Koala",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (Koala.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Koala ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Koala inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Koala dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Koala",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Koala sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Koala suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Koala.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Koala",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Koala.",
