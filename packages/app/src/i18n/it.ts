export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Koala",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Koala.",
  ...
  "dialog.plugins.empty": "Plugin configurati in Koala.json",
  ...
  "dialog.server.description": "Cambia il server Koala a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Koala in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Koala in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Koala in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Koala in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Koala possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Koala non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Koala ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Koala",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (Koala.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Koala non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Koala all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Koala",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Koala sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Koala segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Koala.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Koala",
  ...
  "settings.updates.toast.latest.title": "Koala è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Koala.",
  ...
  "desktop.menu.documentation": "Documentazione di Koala",
  ...
  "desktop.menu.ariaLabel": "Menu Koala",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Koala",
  "desktop.recovery.terminated": "La finestra di Koala si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Koala non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Koala non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "Koala non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "Koala è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "Koala non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Koala è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
