export const dict = {
  ...
  "desktop.menu.documentation": "Koala-documentatie",
  ...
  "desktop.recovery.loadFailed": "Koala kan niet worden geladen",
  "desktop.recovery.terminated": "Het Koala-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Koala reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Koala is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "Koala is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "Koala is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "Koala is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Koala-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Koala",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Koala te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Koala te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Koala te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in Koala.json",
  ...
  "dialog.server.description": "Wijzig met welke Koala-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Koala controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Koala controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Koala bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Koala bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Koala bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Koala bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Koala is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Koala in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Koala een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Koala kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Koala opnieuw.",
  ...
  "help.tabs.introduction": "Koala Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Koala ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Koala-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (Koala.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Koala ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Koala bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Koala-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Koala",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Koala eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Koala het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Koala aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Koala wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Koala is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Koala.",
