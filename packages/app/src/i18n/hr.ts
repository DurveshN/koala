...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Koala se nije uspio učitati",
  "Prozor aplikacije Koala neočekivano je zatvoren",
  "Koala ne reagira",
  ...
  "Instalacija aplikacije Koala nije uspjela",
  ...
  "Koala nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Koala je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Koala",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Koala.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u Koala.json",
  ...
  "dialog.server.description": "Promijenite na koji se Koala poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Koala u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Koala u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Koala u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Koala u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Koala",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Koala može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Koala nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Koala.",
  ...
  "help.tabs.introduction": "Radna površina Koala sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Koala ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Koala timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (Koala.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Koala još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Koala uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Koala Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Koala poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Koala",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Koala izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Koala slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Koala tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Koala pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Koala.",
