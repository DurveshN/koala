export const dict = {
  ...
  "desktop.menu.documentation": "Koala Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Koala մենյու",
  ...
  "desktop.recovery.loadFailed": "Koala չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Koala պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Koala-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Koala տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.opencodeMissing": "Koala-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.opencodeCannotRun": "Koala-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.opencodeNotInstalled": "Koala տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koala թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Koala",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Koala-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Koala-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Koala-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են Koala.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Koala սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Koala-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Koala-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Koala-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Koala պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Koala-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Koala-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Koala-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Koala։",
  ...
  "help.tabs.introduction": "Koala Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koala-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Koala թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (Koala.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Koala-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Koala ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Koala սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Koala",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Koala տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Koala-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Koala-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Koala-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Koala-ի վերջին տարբերակը։",
