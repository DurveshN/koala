export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koala yüklənə bilmədi",
  "desktop.recovery.terminated": "Koala pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Koala cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Koala quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə Koala quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "Koala quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "Koala {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Koala yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koala tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Koala-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Koala-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Koala-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər Koala.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Koala serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Koala yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Koala yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Koala yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Koala yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Koala-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Koala-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Koala {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Koala hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Koala-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Koala quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koala WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Koala bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Koala-u yenidən açın.",
  ...
  "help.tabs.introduction": "Koala Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koala-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Koala komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (Koala.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Koala hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Koala-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Koala serverini işlət.",
  ...
  "settings.general.row.language.description": "Koala üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Koala-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Koala-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Koala-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Koala açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Koala-un ən son versiyasından istifadə edirsiniz.",
