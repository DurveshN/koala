...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Koala",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Koala zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "Koala.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Koala zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Koala zu nutzen.",
  ...
  "dialog.plugins.empty": "In Koala.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Koala-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Koala",
  ...
  "wsl.onboarding.checkingOpencode": "Koala wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Koala in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Koala wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Koala in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Koala in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Koala aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Koala ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Koala ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Koala in {{distro}}.",
  "wsl.onboarding.installOpencode": "Koala installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Koala einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Koala konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Koala erneut.",
  ...
  "toast.update.description": "Eine neue Version von Koala ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Koala-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (Koala.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Koala unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Koala mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Koala enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Koala Desktop",
  ...
  "settings.desktop.wsl.description": "Koala-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Koala ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Koala auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Koala dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Koala anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Koala automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Koala ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Koala wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Koala konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Koala-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Koala reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Koala-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "Koala ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "Koala ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "Koala ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Koala-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Koala Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
