export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Koala",
  ...
  "desktop.menu.ariaLabel": "Koala meni",
  ...
  "desktop.recovery.loadFailed": "Koala se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Koala-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Koala ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Koala-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.opencodeMissing": "Koala nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "Koala je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "Koala nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Koala-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Koala",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Koala-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Koala-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Koala-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u Koala.json",
  ...
  "dialog.server.description": "Promijeni na koji se Koala server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Koala u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Koala u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Koala u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Koala u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Koala mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Koala nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Koala-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Koala timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (Koala.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Koala još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Koala uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Koala server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Koala-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Koala izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Koala prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Koala-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Koala pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Koala-a.",
