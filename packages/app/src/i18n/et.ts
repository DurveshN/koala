export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koala laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Koala aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Koala ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Koala installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "Koala pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "Koala on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "Koala pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koala värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Koala",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Koala'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Koala.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis Koala.json",
  ...
  "dialog.server.description": "Lülitage, millise Koala serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Koala kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Koala kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Koala värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Koala värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Koala jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Koala asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Koala saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Koala ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Koala.",
  ...
  "help.tabs.introduction": "Koala Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Koala ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Koala meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (Koala.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Koala ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Koala sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Koala Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Koala server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Koala kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Koala teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Koala järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Koala on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Koala käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Koala uusimat versiooni.",
