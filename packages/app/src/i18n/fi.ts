export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Koalan tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Koalassa.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Koalassa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Koalassa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään Koala.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Koala-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Koalaa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Koalaa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Koalaa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Koalaa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Koala jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Koala jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koalaa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Koala voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Koala ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Koala uudelleen.",
  ...
  "toast.update.description": "Koalan uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Koala-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (Koala.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Koala ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Koala sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Koala-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Koalan näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Koala näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Koala järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Koalan teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Koala käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Koalan uusinta versiota.",
  ...
  "desktop.menu.documentation": "Koala-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Koala-valikko",
  ...
  "desktop.recovery.loadFailed": "Koalan lataaminen epäonnistui",
  "desktop.recovery.terminated": "Koala-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Koala ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Koalan asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeCannotRun": "Koala on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "Koalaa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koalan päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Koala Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
