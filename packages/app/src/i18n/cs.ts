export const dict = {
  ...
  "desktop.menu.documentation": "Koala Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Koala",
  ...
  "desktop.recovery.loadFailed": "Koala se nepodařilo načíst",
  "desktop.recovery.terminated": "Koala okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Koala nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Koala instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "Koala není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "Koala je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "Koala není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koala aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Koala.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v Koala.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Koala serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Koala v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Koala v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Koala v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Koala do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Koala může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Koala nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Koala.",
  ...
  "help.tabs.introduction": "Koala Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Koala ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Koala",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (Koala.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Koala zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Koala uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Koala",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Koala na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Koala následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Koala.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Koala",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Koala.",
