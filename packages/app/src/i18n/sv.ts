export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koala kunde inte läsas in",
  "desktop.recovery.terminated": "Koala-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Koala svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Koala misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "Koala är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "Koala är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "Koala är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koala-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Koala",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Koala.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i Koala.json",
  ...
  "dialog.server.description": "Växla vilken Koala-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Koala i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Koala i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Koala i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Koala i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Koala kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Koala kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Koala igen.",
  ...
  "help.tabs.introduction": "Koala Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Koala ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Koala-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (Koala.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Koala stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Koala innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Koala-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Koala",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Koala ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Koala följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Koalas tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Koala startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Koala.",
