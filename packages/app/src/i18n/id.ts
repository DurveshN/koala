export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koala gagal dimuat",
  "desktop.recovery.terminated": "Jendela Koala berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Koala tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Koala gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.opencodeMissing": "Koala belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Koala telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Koala belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Koala selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Koala",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Koala.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di Koala.json",
  ...
  "dialog.server.description": "Ganti server Koala mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Koala di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Koala di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Koala di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Koala di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Koala dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Koala tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Koala ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Koala",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (Koala.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Koala belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Koala di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Koala",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Koala di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Koala mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Koala diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Koala.",
