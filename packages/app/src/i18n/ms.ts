export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Koala",
  ...
  "desktop.recovery.loadFailed": "Koala gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Koala ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Koala tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Koala gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "Koala tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Koala dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "Koala tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Koala selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Koala",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Koala.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam Koala.json",
  ...
  "dialog.server.description": "Tukar pelayan Koala yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Koala dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Koala dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Koala dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Koala dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Koala boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Koala tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Koala ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Koala",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (Koala.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Koala belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Koala dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Koala",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Koala pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Koala mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Koala.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Koala dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Koala.",
