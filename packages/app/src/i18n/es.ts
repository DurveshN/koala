export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Koala",
  ...
  "desktop.menu.ariaLabel": "Menú de Koala",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Koala",
  "desktop.recovery.terminated": "La ventana de Koala se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Koala no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Koala",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "Koala no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "Koala está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "Koala no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Koala finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Koala",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Koala.",
  ...
  "dialog.plugins.empty": "Plugins configurados en Koala.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Koala al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Koala en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Koala en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Koala en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Koala en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Koala pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Koala no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Koala ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Koala",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (Koala.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Koala aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Koala incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Koala dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Koala",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Koala en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Koala sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Koala.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Koala",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Koala.",
