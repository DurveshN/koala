export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koalaを読み込めませんでした",
  "desktop.recovery.terminated": "Koalaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Koalaが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Koalaのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはKoalaがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Koalaのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Koalaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Koalaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してKoalaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Koalaで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "Koala.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するKoalaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Koalaを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のKoalaを確認中...",
  "wsl.onboarding.updatingOpencode": "Koalaを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のKoalaを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のKoalaを更新してください。",
  "wsl.onboarding.updateOpencode": "Koalaを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のKoalaの準備ができました。",
  "wsl.onboarding.opencodeReady": "Koalaの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にKoalaをインストールしてください。",
  "wsl.onboarding.installOpencode": "Koalaをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koalaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "KoalaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Koalaをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Koala Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koalaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKoalaチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (Koala.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: KoalaはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Koalaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でKoalaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Koalaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKoalaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Koalaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Koalaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Koala の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Koala は最新バージョンです。",
