export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Koala",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Koala.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i Koala.json",
  ...
  "dialog.server.description": "Skift hvilken Koala-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Koala i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Koala i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Koala i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Koala kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Koala kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Koala igen.",
  ...
  "toast.update.description": "En ny version af Koala ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Koala-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (Koala.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Koala understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Koala inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Koala-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Koala",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Koala ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Koala skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Koalas tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Koala starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Koala.",
  ...
  "desktop.recovery.loadFailed": "Koala kunne ikke indlæses",
  "desktop.recovery.terminated": "Koala-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Koala mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.opencodeMissing": "Koala er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "Koala er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "Koala er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Koala er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Koala Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
