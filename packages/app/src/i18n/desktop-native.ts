...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Koala failed to load",
  "desktop.recovery.terminated": "Koala window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Koala is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Koala installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.opencodeMissing": "Koala is not installed in this distro",
  "desktop.wsl.error.opencodeCannotRun": "Koala is installed but could not run",
  "desktop.wsl.error.opencodeNotInstalled": "Koala is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Koala update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
