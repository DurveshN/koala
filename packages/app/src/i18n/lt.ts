...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Koala įkelti nepavyko",
  "Koala langas netikėtai užsidarė",
  "Koala neatsako",
  ...
  "Koala įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Koala neįdiegtas distributyve {{distro}}",
  "Koala naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Koala modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Koala.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti Koala.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Koala serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Koala {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Koala {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Koala {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Koala į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Koala galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Koala nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Koala ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Koala komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (Koala.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Koala dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Koala apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Koala darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Koala serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Koala ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Koala atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Koala seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Koala temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Koala",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Koala versiją.",
