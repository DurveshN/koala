...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Koala",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Koala.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Koala Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Koala.",
  ...
  "dialog.plugins.empty": "Plugins configured in Koala.json",
  ...
  "dialog.server.description": "Switch which Koala server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Koala in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Koala in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Koala in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Koala in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Koala can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Koala could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Koala ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Koala team",
  ...
  "error.chain.checkConfig": "Check your config (Koala.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Koala does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Koala includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Koala server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Koala",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Koala looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Koala follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Koala is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Koala launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Koala.",
