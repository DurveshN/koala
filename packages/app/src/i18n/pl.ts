export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Koala",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Koala",
  "desktop.recovery.terminated": "Okno Koala zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Koala nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Koala",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program Koala nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program Koala jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "Koala nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Koala została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Koala",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Koala.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku Koala.json",
  ...
  "dialog.server.description": "Przełącz serwer Koala, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Koala w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Koala w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Koala w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Koala w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Koala",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Koala będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Koala nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Koala.",
  ...
  "help.tabs.introduction": "Koala Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Koala ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Koala",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (Koala.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Koala nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Koala zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Koala wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Koala",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Koala na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Koala ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Koala.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Koala",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Koala.",
