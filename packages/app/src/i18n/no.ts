...
export const dict = {
  ...
  "desktop.menu.documentation": "Koala-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Koala-meny",
  ...
  "desktop.recovery.loadFailed": "Koala kunne ikke lastes inn",
  "desktop.recovery.terminated": "Koala-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Koala svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Koala mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "Koala er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "Koala er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "Koala er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Koala er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Koala",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Koala.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Koala.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Koala.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i Koala.json",
  ...
  "dialog.server.description": "Bytt hvilken Koala-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Koala ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Koala-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (Koala.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Koala ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Koala inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Koala-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Koala",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Koala ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Koala skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Koala.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Koala starter",
  ...
  "settings.updates.toast.latest.title": "Koala er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Koala.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Koala...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Koala i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Koala...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Koala i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Koala i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Koala",
  "wsl.onboarding.opencodeReadyIn": "Koala er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Koala er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Koala i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Koala kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Koala kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Koala på nytt.",
  ...
  "help.tabs.introduction": "Koala Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
