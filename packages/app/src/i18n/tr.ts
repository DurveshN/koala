...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koala yüklenemedi",
  "desktop.recovery.terminated": "Koala penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Koala yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Koala kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.opencodeMissing": "Koala bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "Koala kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "Koala, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Koala güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Koala tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Koala'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Koala Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Koala'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Koala'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler Koala.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Koala sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Koala kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Koala kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Koala güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Koala güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Koala'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Koala'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Koala hazır.",
  "wsl.onboarding.opencodeReady": "Koala hazır.",
  "wsl.onboarding.installOpencodeIn": "Koala'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Koala'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Koala kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Koala'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Koala bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Koala'u tekrar açın.",
  ...
  "help.tabs.introduction": "Koala Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koala'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Koala ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (Koala.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Koala henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Koala ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Koala Masaüstü",
  ...
  "settings.desktop.wsl.description": "Koala sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Koala'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Koala'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Koala'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Koala'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Koala başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Koala'un en son sürümünü kullanıyorsunuz.",
