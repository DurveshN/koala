...
const GLOBAL_STORAGE = "koala.global.dat"
const WINDOW_STORAGE = "koala.window"
const LOCAL_PREFIX = "koala."
...
function workspaceStorage(dir: string) {
  ...
  return `koala.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `koala.draft.${head}.${sum}.dat`
}
